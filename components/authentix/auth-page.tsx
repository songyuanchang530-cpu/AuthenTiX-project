...
const WeChatIcon = () => (
  <svg className="size-6 fill-[#07C160]" viewBox="0 0 24 24">
...
const QQIcon = () => (
  <svg className="size-6 fill-[#12B7F5]" viewBox="0 0 24 24">
...
const AppleIcon = () => (
  <svg className="size-6 fill-black dark:fill-white" viewBox="0 0 24 24">
...
const LiquidGlassButton = ({ 
  ...
  <button
    className="relative flex size-11 items-center justify-center overflow-hidden rounded-full transition-all duration-300 active:scale-[0.97]
      bg-white/50 backdrop-blur-md border border-white/30
      shadow-[inset_0_1.5px_3px_rgba(255,255,255,0.6),inset_0_-1.5px_3px_rgba(0,0,0,0.05),0_4px_12px_rgba(0,0,0,0.08)]
      hover:scale-105 hover:bg-white/60 hover:shadow-[inset_0_2px_4px_rgba(255,255,255,0.8),inset_0_-2px_4px_rgba(0,0,0,0.1),0_8px_20px_rgba(0,0,0,0.12)]
      dark:bg-slate-800/50 dark:border-white/10
      dark:shadow-[inset_0_1.5px_3px_rgba(255,255,255,0.1),inset_0_-1.5px_3px_rgba(0,0,0,0.2),0_4px_12px_rgba(0,0,0,0.3)]
      dark:hover:bg-slate-700/60 dark:hover:shadow-[inset_0_2px_4px_rgba(255,255,255,0.15),inset_0_-2px_4px_rgba(0,0,0,0.25),0_8px_20px_rgba(0,0,0,0.4)]"
    title={name}
    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-slate-50 via-white to-slate-100 p-4 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <div className="mx-auto w-full max-w-[430px]">
        ...
        <div className="mt-6">
          ...
          {/* Social Icons Grid - 2 rows x 6 columns - Apple Liquid Glass */}
          <div className="grid grid-cols-6 justify-items-center gap-3 sm:gap-4">
            {/* Row 1 */}
            <LiquidGlassButton name="WeChat">
              <WeChatIcon />
            </LiquidGlassButton>
            <LiquidGlassButton name="QQ">
              <QQIcon />
            </LiquidGlassButton>
            <LiquidGlassButton name="Google">
              <GoogleIcon />
            </LiquidGlassButton>
            <LiquidGlassButton name="Apple">
              <AppleIcon />
            </LiquidGlassButton>
            <LiquidGlassButton name="Microsoft">
              <MicrosoftIcon />
            </LiquidGlassButton>
            <LiquidGlassButton name="TikTok">
              <TikTokIcon />
            </LiquidGlassButton>
            
            {/* Row 2 */}
            <LiquidGlassButton name="Facebook">
              <Facebook className="size-6 text-[#1877F2]" />
            </LiquidGlassButton>
            <LiquidGlassButton name="GitHub">
              <Github className="size-6 text-[#333333] dark:text-white" />
            </LiquidGlassButton>
            <LiquidGlassButton name="WhatsApp">
              <MessageCircle className="size-6 text-[#25D366]" />
            </LiquidGlassButton>
            <LiquidGlassButton name="Instagram">
              <Instagram className="size-6 text-[#E4405F]" />
            </LiquidGlassButton>
            <LiquidGlassButton name="X">
              <XTwitterIcon />
            </LiquidGlassButton>
            <LiquidGlassButton name="Telegram">
              <TelegramIcon />
            </LiquidGlassButton>
          </div>
        </div>
