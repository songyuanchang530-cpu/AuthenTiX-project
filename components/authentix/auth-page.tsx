...
// iOS App Store Style SVG Icons - White fills for solid colored backgrounds
const WeChatIcon = () => (
...
// iOS App Store Squircle Button - Premium Solid Brand Colors
const AppStoreButton = ({ 
  ...
  <button
    className={cn(
      "relative flex size-12 items-center justify-center rounded-[14px] transition-all duration-200 hover:scale-105 active:scale-[0.95]",
      "shadow-[inset_0_1px_1px_rgba(255,255,255,0.4),0_4px_10px_rgba(0,0,0,0.15)]",
      "dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_4px_10px_rgba(0,0,0,0.4)]",
      bgClass
    )}
    title={name}
    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-slate-50 via-white to-slate-100 p-4 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <div className="mx-auto w-full max-w-[430px]">
        ...
        <div className="mt-6">
          ...
          {/* Social Icons Grid - 2x6 iOS App Store Style Squircles */}
          <div className="grid grid-cols-6 justify-items-center gap-3 sm:gap-4">
            {/* Row 1 */}
            <AppStoreButton name="WeChat" bgClass="bg-[#07C160]">
              <WeChatIcon />
            </AppStoreButton>
            <AppStoreButton name="QQ" bgClass="bg-[#12B7F5]">
              <QQIcon />
            </AppStoreButton>
            <AppStoreButton name="Google" bgClass="bg-white dark:bg-slate-800">
              <GoogleIcon />
            </AppStoreButton>
            <AppStoreButton name="Apple" bgClass="bg-black dark:bg-white">
              <span className="dark:hidden"><AppleIconWhite /></span>
              <span className="hidden dark:block"><AppleIconBlack /></span>
            </AppStoreButton>
            <AppStoreButton name="Microsoft" bgClass="bg-white dark:bg-slate-800">
              <MicrosoftIcon />
            </AppStoreButton>
            <AppStoreButton name="TikTok" bgClass="bg-black">
              <TikTokIcon />
            </AppStoreButton>
            
            {/* Row 2 */}
            <AppStoreButton name="Facebook" bgClass="bg-[#1877F2]">
              <FacebookIcon />
            </AppStoreButton>
            <AppStoreButton name="GitHub" bgClass="bg-[#181717] dark:bg-white">
              <span className="dark:hidden"><GitHubIconWhite /></span>
              <span className="hidden dark:block"><GitHubIconBlack /></span>
            </AppStoreButton>
            <AppStoreButton name="Google Voice" bgClass="bg-[#1DA462]">
              <GoogleVoiceIcon />
            </AppStoreButton>
            <AppStoreButton name="Instagram" bgClass="bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888]">
              <InstagramIcon />
            </AppStoreButton>
            <AppStoreButton name="X" bgClass="bg-black dark:bg-white">
              <span className="dark:hidden"><XTwitterIconWhite /></span>
              <span className="hidden dark:block"><XTwitterIconBlack /></span>
            </AppStoreButton>
            <AppStoreButton name="Telegram" bgClass="bg-[#2AABEE]">
              <TelegramIcon />
            </AppStoreButton>
          </div>
        </div>
