...
// Full-bleed brand circle button with white icon
const BrandCircleButton = ({ 
  ...
  <button
    className={cn(
      "flex size-11 items-center justify-center overflow-hidden rounded-full shadow-sm transition-all duration-200 hover:scale-110 hover:shadow-md active:scale-95",
      bgClass
    )}
    title={name}
    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-slate-50 via-white to-slate-100 p-4 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <div className="mx-auto w-full max-w-[430px]">
        ...
        <div className="mt-6">
          ...
          {/* Social Icons Grid - 2 rows x 6 columns - Full-bleed brand circles */}
          <div className="grid grid-cols-6 justify-items-center gap-3 sm:gap-4">
            {/* Row 1 */}
            <BrandCircleButton name="WeChat" bgClass="bg-[#07C160]">
              <WeChatIcon />
            </BrandCircleButton>
            <BrandCircleButton name="QQ" bgClass="bg-[#12B7F5]">
              <QQIcon />
            </BrandCircleButton>
            <BrandCircleButton name="Google" bgClass="bg-white border border-slate-200 dark:border-slate-700">
              <GoogleIcon />
            </BrandCircleButton>
            <BrandCircleButton name="Apple" bgClass="bg-black dark:bg-white">
              <AppleIcon className="fill-white dark:fill-black" />
            </BrandCircleButton>
            <BrandCircleButton name="Microsoft" bgClass="bg-white border border-slate-200 dark:border-slate-700">
              <MicrosoftIcon />
            </BrandCircleButton>
            <BrandCircleButton name="TikTok" bgClass="bg-black">
              <TikTokIcon />
            </BrandCircleButton>
            
            {/* Row 2 */}
            <BrandCircleButton name="Facebook" bgClass="bg-[#1877F2]">
              <Facebook className="size-5 text-white" />
            </BrandCircleButton>
            <BrandCircleButton name="GitHub" bgClass="bg-[#333333] dark:bg-white">
              <Github className="size-5 text-white dark:text-black" />
            </BrandCircleButton>
            <BrandCircleButton name="WhatsApp" bgClass="bg-[#25D366]">
              <MessageCircle className="size-5 text-white" />
            </BrandCircleButton>
            <BrandCircleButton name="Instagram" bgClass="bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888]">
              <Instagram className="size-5 text-white" />
            </BrandCircleButton>
            <BrandCircleButton name="X" bgClass="bg-black dark:bg-white">
              <XTwitterIcon className="fill-white dark:fill-black" />
            </BrandCircleButton>
            <BrandCircleButton name="Telegram" bgClass="bg-[#2AABEE]">
              <TelegramIcon />
            </BrandCircleButton>
          </div>
        </div>
