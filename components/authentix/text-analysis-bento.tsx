    ...
    <div className="grid flex-1 grid-cols-1 items-stretch gap-8 lg:grid-cols-12">
      ...
      <div className="flex h-full flex-col gap-6 lg:col-span-5">
        ...
        <div
          ...
          onDrop={handleDrop}
          className={`relative flex flex-1 flex-col rounded-3xl bg-white p-6 shadow-xl shadow-indigo-100/50 transition-all dark:bg-[#161B26]/80 dark:backdrop-blur-2xl dark:border dark:border-white/[0.04] dark:shadow-[0_8px_30px_rgba(0,0,0,0.4)] ${
        ...
        >
          ...
          {/* File indicator */}
          {uploadedFile && (
            <div className="mb-4 flex items-center gap-3 rounded-2xl bg-slate-100 p-3 dark:bg-white/5 dark:border dark:border-white/[0.04]">
      ...
      <div className="flex h-full flex-col gap-6 lg:col-span-7">
        ...
        <div className="flex items-center gap-8 rounded-3xl bg-white p-6 shadow-xl shadow-indigo-100/50 dark:bg-[#161B26]/80 dark:backdrop-blur-2xl dark:border dark:border-white/[0.04] dark:shadow-[0_8px_30px_rgba(0,0,0,0.4)]">
          {/* Circular Progress */}
        ...
        <div className="relative flex flex-1 flex-col rounded-3xl bg-white p-8 shadow-xl shadow-indigo-100/50 dark:bg-[#161B26]/80 dark:backdrop-blur-2xl dark:border dark:border-white/[0.04] dark:shadow-[0_8px_30px_rgba(0,0,0,0.4)]">
          {/* Legend */}
          <div className="absolute right-6 top-6 flex items-center gap-4 rounded-full bg-slate-100 px-4 py-2 dark:bg-white/10 dark:border dark:border-white/[0.04]">
