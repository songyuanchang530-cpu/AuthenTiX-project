...
export function UserProfileBento() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch min-h-[600px]" translate="no">
      ...
      <div className="lg:col-span-4 flex flex-col h-full rounded-3xl bg-white p-8 items-center text-center relative overflow-hidden shadow-xl shadow-indigo-100/50 dark:bg-[#161B26]/80 dark:backdrop-blur-2xl dark:border dark:border-white/[0.04] dark:shadow-[0_8px_30px_rgba(0,0,0,0.4)]">
        {/* Subtle glow effect */}
      ...
      <div className="lg:col-span-8 flex flex-col h-full gap-6">
        ...
        <div className="flex gap-6 flex-1">
          {/* Box A - Stats */}
          <div className="flex-1 rounded-3xl bg-white p-6 flex flex-col justify-center shadow-xl shadow-indigo-100/50 dark:bg-[#161B26]/80 dark:backdrop-blur-2xl dark:border dark:border-white/[0.04] dark:shadow-[0_8px_30px_rgba(0,0,0,0.4)]">
          ...
          {/* Box B - Plan Status */}
          <div className="flex-1 rounded-3xl bg-white p-6 flex flex-col justify-center relative shadow-xl shadow-indigo-100/50 dark:bg-[#161B26]/80 dark:backdrop-blur-2xl dark:border dark:border-white/[0.04] dark:shadow-[0_8px_30px_rgba(0,0,0,0.4)]">
        ...
        <div className="w-full flex-1 rounded-3xl bg-white p-6 shadow-xl shadow-indigo-100/50 dark:bg-[#161B26]/80 dark:backdrop-blur-2xl dark:border dark:border-white/[0.04] dark:shadow-[0_8px_30px_rgba(0,0,0,0.4)]">
        ...
        <div className="w-full flex-1 rounded-3xl bg-white p-6 flex items-center justify-between shadow-xl shadow-indigo-100/50 dark:bg-[#161B26]/80 dark:backdrop-blur-2xl dark:border dark:border-white/[0.04] dark:shadow-[0_8px_30px_rgba(0,0,0,0.4)]">
          {/* Language Selector */}
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                {languageOpen && (
                  <div className="absolute top-full left-0 mt-2 rounded-xl bg-white py-2 min-w-[120px] shadow-xl ring-1 ring-slate-100 z-10 dark:bg-[#161B26] dark:ring-white/[0.04]">
