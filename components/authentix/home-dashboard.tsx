    ...
    <div className="scrollbar-hide flex-1 overflow-y-auto">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="col-span-1 md:col-span-2 lg:col-span-4">
          <div className="flex flex-col items-center justify-between gap-8 rounded-3xl bg-white p-8 shadow-xl shadow-indigo-100/50 md:flex-row dark:bg-[#161B26]/80 dark:backdrop-blur-2xl dark:border dark:border-white/[0.04] dark:shadow-[0_8px_30px_rgba(0,0,0,0.4)]">
            {/* Left Text */}
        ...
        <div className="col-span-1 rounded-3xl bg-white p-6 shadow-xl shadow-indigo-100/50 md:col-span-2 dark:bg-[#161B26]/80 dark:backdrop-blur-2xl dark:border dark:border-white/[0.04] dark:shadow-[0_8px_30px_rgba(0,0,0,0.4)]">
